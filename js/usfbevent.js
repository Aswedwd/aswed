            ...
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    a = a.objectWithFields({
                        ...
                        forkedPixelIdsInBrowserChannel: a.arrayOf(a.string()),
                        forkedPixelIdsInServerChannel: a.arrayOf(a.string())
                    });
                    k.exports = a
                }
                )();
                ...
                (function() {
                    ...
                    function pa(a) {
                        ...
                        case "openbridge":
                            var B = c[0]
                              , C = c[1];
                            B !== null && C !== null && typeof B === "string" && typeof C === "string" && (U.callMethod(["optIn", B, "OpenBridge"]),
                    ...
                    function Z(a, b, c) {
                        ...
                        if (M.call(R, d)) {
                            b != null && z(R[d].userData) ? (R[d].userData = e ? b || {} : {},
                            V.loadPlugin("identity")) : H({
                                pixelID: d,
                    ...
                    function ta(a, b, c) {
                        for (var d = 0, e = Q.length; d < e; d++) {
                            var f = Q[d];
                            if (!(a === "PageView" && this.allowDuplicatePageViews) && Object.prototype.hasOwnProperty.call(T, a) && T[a].has(f.id))
                                continue;
